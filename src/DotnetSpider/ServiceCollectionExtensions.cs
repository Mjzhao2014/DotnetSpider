...
public static class ServiceCollectionExtensions
{
    ...
    {
        collection.TryAddSingleton<IStatisticService, StatisticService>();
    ...
    public static Builder UseRequestHasher<TRequestHasher>(this Builder builder)
        where TRequestHasher : class, IRequestHasher
    {
        builder.ConfigureServices(x =>
        {
