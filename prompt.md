...
3. Parse and interpret robots.txt according to following rules:
     - It consists of groups of rules starting with one or more User-agent: lines followed by directives such as Disallow:, Allow:, and optional Sitemap: entries.
...
4. Interpret each directive as follows:
   ...
   - Disallow — Lists URL path prefixes that the crawler must not request. Example: Disallow: /private/ means do not fetch anything under /private/.
